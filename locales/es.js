export default {
  common: {
    ...
    loading: 'Cargando...',
    description: 'QiSwap es un protocolo completamente decentralizado el cual automaticamente provee liquides para QTUM basado en algoritmos de manejo de mercados automatizados (AMM).',
    announcement: 'QiSwap funciona en QTUM red principal, recuerde, esto aun es software experimental, utilizalo bajo tu propio riesgo.',
  ...
  footer: {
    intro: 'QiSwap es un protocolo completamente decentralizado el cual automaticamente provee liquides para QTUM basado en algoritmos de manejo de mercados automatizados (AMM).',
    contact: 'Contactenos'
  },
  index: {
    banner: {
      ...
      qiswap: 'NOTA: Es necesario tener instalado QiWallet para que QiSwap pueda funcionar correctamente. Si no has instalado QiWallet, por favor instalala antes de continuar.'
    },
    plates: {
      features: {
        content: [
          {
            title: 'Transparente',
            icon: 'transparent',
            content: 'QiSwap es una infrastructura creada en QTUM transparente y resistente a la censura.'
          },
          {
            title: 'Estable',
            icon: 'lower',
            content: 'QiSwap tiene tarifas de manejo mucho mas bajas, confirmacion de transacciones mas rapida y precios mas estables.'
          },
          {
            title: 'Libre',
            icon: 'open',
            content: 'QiSwap le permite a cualquiera crear nuevos mercados, proveer liquidez, y crear aplicaciones financieras que no podrian haber existido antes.'
          }
        ]
      },
      use: {
        ...
        content: [
          {
            ...
            content: 'La direccion de contrato de QIAD es: https://qtum.info/contract/f52150072f31b7ba1985a2145531967b1a5a7cea'
          },
          {
            title: 'Cual es la direccion de contrato de QI?',
            content: 'La direccion de contrato de QI es: https://qtum.info/qrc20/54fefdb5b31164f66ddb68becd7bdd864cacd65b'
          },
          {
            title: 'Por que necesito pagar por Gas?',
            content: 'Cuando los tokens son enviados y los contratos inteligentes son ejecutados, los recursos de la red necesitan ser consumidos, asi que las tarifas de gas deben ser pagadas para permitirle a los mineros empaquetar transacciones para ud. Pero QTUM es muy barato.'
          }
        ]
      }
    }
  ...
  swap: {
    ...
    poolInfo: {
      ...
      ratio: 'El porcentaje de tokens que ud agregue va a determinar el precio de este pool.',
      click: 'Una vez que este contento con el porcentaje, dele click en agregar liquidez.',
