  ...
  <nav class="w-full flex flex-col">
    ...
    >
      ...
      <div
        ...
        "
        class="w-64 h-screen md:w-auto md:h-auto fixed md:relative right-0 inset-y-0 md:m-0 flex-grow md:block md:bg-transparent shadow-lg md:shadow-none transition-normal z-30"
      >
        <div class="flex flex-col md:flex-row justify-end items-center text-sm">
          ...
          <a
            :href="`https://${domain}`"
            target="_blank"
            class="text-center leading-8 md:leading-normal py-4 md:mx-6 transition-normal"
          >
            {{ $t('nav.browser') }}
          </a>
        ...
        >
          ...
          <div class="flex justify-between pl-8">
            <button
              ...
              class="flex items-center text-xs hover:opacity-75 border px-2 py-px rounded-full"
