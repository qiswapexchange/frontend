<template>
  <div class="w-full overflow-hidden flex items-center justify-between mb-2 text-xs">
    ...
    <SwapTxLink v-else-if="type === 'addLiquidity'" v-bind="raw">
      <img src="@/assets/icons/record/addLiquidity.svg" alt="" class="w-4 mr-4">
      <span>
        {{ $t('transaction.add', {
    ...
    <SwapTxLink v-else-if="type === 'removeLiquidity'" v-bind="raw">
      <img src="@/assets/icons/record/removeLiquidity.svg" alt="" class="w-4 mr-4">
      <span>
    ...
    <SwapTxLink v-else v-bind="raw">
      View Tx
    </SwapTxLink>
    <Spinner v-if="pending" :width="4" class="text-blue-600" />
    <img v-else-if="success" src="@/assets/icons/success.svg" alt="" class="w-4">
