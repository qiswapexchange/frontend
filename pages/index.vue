<template>
  <section class="overflow-hidden">
    <!-- 宣传幕布 -->
    <section class="relative h-xl z-0" data-aos="zoom-in">
      <!-- 例子效果 -->
      <vue-particles
        class="particles-wrap particles-size"
        color="#ffffff"
        :particle-size="1"
        :particles-number="2000"
        :click-effect="false"
        :hover-effect="false"
        :line-linked="false"
        :particle-opacity="1"
      ...
      <section class="w-full lg:w-1/2 h-full mx-auto pt-8 pb-16 lg:px-0 flex flex-col items-center justify-between z-20">
        ...
        <!-- more -->
        <div v-scroll-to="'#features'" class="more-content cursor-pointer">
          <img src="@/assets/icons/home/arrow-more.svg" alt="" class="w-8 select-none">
        </div>
      </section>
    </section>
...
.particles-wrap {
  ...
  overflow: hidden;
  z-index: -1;
  background-image: url('../assets/icons/home/home-bg.svg');
...
.more-content::before {
  animation: spread 2s ease infinite;
}
.more-content::after {
  animation: spread 2s ease .2s infinite;
}
@keyframes shaking {
  0%, 100% {
